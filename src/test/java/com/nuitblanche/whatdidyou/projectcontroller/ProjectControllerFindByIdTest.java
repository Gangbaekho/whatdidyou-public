...
public class ProjectControllerFindByIdTest {
    ...
    public void findPostById(){
        ...
        ProjectResponseDto responseDto = mapper.convertValue(getResponseEntity.getBody().getData(),ProjectResponseDto.class);
