...
public class PostControllerFindCurrnetPagePostsInProjectTest {
    ...
    @Test
    public void findCurrnetPagePosts(){
        ...
        String getUrl =  "http://localhost:" + port + "/api/v1/posts/projects/"+projectTwo.getId()+"/pages/"+0L;;
        ...
        assertThat(responseDto.getPosts().size()).isEqualTo(5);
    }
}
