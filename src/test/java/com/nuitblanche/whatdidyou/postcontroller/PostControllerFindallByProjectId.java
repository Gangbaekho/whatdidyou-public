...
public class PostControllerFindallByProjectId {
    ...
    public void findPostById(){
        ...
        String updateUrl = "http://localhost:" + port + "/api/v1/posts/projects/" + projectOne.getId();
        ...
        ResponseEntity<ListResult> getResponseEntity = restTemplate.exchange(updateUrl, HttpMethod.GET,updateRequestEntity,ListResult.class);
